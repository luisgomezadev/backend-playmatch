package com.lgsoftworks.user.infrastructure.adapter.out.persistence;
...
import com.lgsoftworks.user.infrastructure.adapter.out.persistence.repository.UserRepository;
