...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({
            ...
            PersonByDocumentNotFoundException.class,
            PersonByEmailNotFoundException.class,
            ...
            PersonByIdNotFoundException.class,
            PersonWithDocumentExistsException.class,
            PersonWithEmailExistsException.class,
            TeamByIdNotFoundException.class,
            DuplicateOwnerException.class,
            PersonAlreadyAssignedAsAdminException.class,
            PersonTypeNotAllowedToCreateFieldException.class,
            PersonTypeNotAllowedToCreateTeamException.class,
            PersonAlreadyMemberOfTeamException.class,
